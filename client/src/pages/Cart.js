...
function Cart() {
  ...
  return (
    <>
      <Topbar />
      <div className="cart-container"> <div id="alert">
        <span id="alert-closebtn" onClick={alertClose}>&times;</span>
